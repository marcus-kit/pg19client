declare global {
  const RATE_LIMIT_CONFIGS: typeof import('../../server/utils/rateLimit').RATE_LIMIT_CONFIGS
  const __buildAssetsURL: typeof import('../../node_modules/.pnpm/@nuxt+nitro-server@4.2.2_db0@0.3.4_ioredis@5.9.2_magicast@0.5.1_nuxt@4.2.2_@parcel+watc_f05c0620bbd6c991cd0ebdf430263a13/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths').buildAssetsURL
  const __publicAssetsURL: typeof import('../../node_modules/.pnpm/@nuxt+nitro-server@4.2.2_db0@0.3.4_ioredis@5.9.2_magicast@0.5.1_nuxt@4.2.2_@parcel+watc_f05c0620bbd6c991cd0ebdf430263a13/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths').publicAssetsURL
  ...
  const clearSessionCookie: typeof import('../../server/utils/userAuth').clearSessionCookie
  const communityImageLimiter: typeof import('../../server/utils/rateLimit').communityImageLimiter
  const communityMessageLimiter: typeof import('../../server/utils/rateLimit').communityMessageLimiter
  ...
  const createRateLimiter: typeof import('../../server/utils/rateLimit').createRateLimiter
  const createRouter: typeof import('../../node_modules/.pnpm/h3@1.15.5/node_modules/h3').createRouter
  const createUserSession: typeof import('../../server/utils/userAuth').createUserSession
  const defaultContentType: typeof import('../../node_modules/.pnpm/h3@1.15.5/node_modules/h3').defaultContentType
  const defineAppConfig: typeof import('../../node_modules/.pnpm/@nuxt+nitro-server@4.2.2_db0@0.3.4_ioredis@5.9.2_magicast@0.5.1_nuxt@4.2.2_@parcel+watc_f05c0620bbd6c991cd0ebdf430263a13/node_modules/@nuxt/nitro-server/dist/runtime/utils/config').defineAppConfig
  ...
  const endUserSession: typeof import('../../server/utils/userAuth').endUserSession
  ...
  const generateBotResponse: typeof import('../../server/utils/openai').generateBotResponse
  const generateEmbedding: typeof import('../../server/utils/openai').generateEmbedding
  const generateSessionToken: typeof import('../../server/utils/userAuth').generateSessionToken
  const getClientIdentifier: typeof import('../../server/utils/rateLimit').getClientIdentifier
  ...
  const getSessionToken: typeof import('../../server/utils/userAuth').getSessionToken
  const getUserFromSession: typeof import('../../server/utils/userAuth').getUserFromSession
  ...
  const requireRateLimit: typeof import('../../server/utils/rateLimit').requireRateLimit
  const requireUser: typeof import('../../server/utils/userAuth').requireUser
  const resetRateLimit: typeof import('../../server/utils/rateLimit').resetRateLimit
  ...
  const setSessionCookie: typeof import('../../server/utils/userAuth').setSessionCookie
  ...
  const useOpenAI: typeof import('../../server/utils/openai').useOpenAI
...
declare global {
  // @ts-ignore
  export type { BotResponseParams, BotResponseResult, AIBotSettings, RAGSource } from '../../server/utils/openai'
  import('../../server/utils/openai')
}
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/home/anna/Рабочий стол/pg19V/pg19client/node_modules/.pnpm/@nuxt+nitro-server@4.2.2_db0@0.3.4_ioredis@5.9.2_magicast@0.5.1_nuxt@4.2.2_@parcel+watc_f05c0620bbd6c991cd0ebdf430263a13/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/home/anna/Рабочий стол/pg19V/pg19client/node_modules/.pnpm/@nuxt+nitro-server@4.2.2_db0@0.3.4_ioredis@5.9.2_magicast@0.5.1_nuxt@4.2.2_@parcel+watc_f05c0620bbd6c991cd0ebdf430263a13/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { validateConfig } from '/home/anna/Рабочий стол/pg19V/pg19client/server/utils/config';
export { useOpenAI, generateEmbedding, generateBotResponse } from '/home/anna/Рабочий стол/pg19V/pg19client/server/utils/openai';
export { createRateLimiter, communityMessageLimiter, communityImageLimiter, getClientIdentifier, RATE_LIMIT_CONFIGS, requireRateLimit, resetRateLimit } from '/home/anna/Рабочий стол/pg19V/pg19client/server/utils/rateLimit';
export { useSupabaseServer } from '/home/anna/Рабочий стол/pg19V/pg19client/server/utils/supabase';
export { generateSessionToken, setSessionCookie, clearSessionCookie, getSessionToken, getUserFromSession, requireUser, createUserSession, endUserSession } from '/home/anna/Рабочий стол/pg19V/pg19client/server/utils/userAuth';