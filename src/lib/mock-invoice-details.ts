/**
 * Моковые данные детализации счёта (состав услуг).
 * Содержит два адреса, каждый с услугами (аренда сети, пакет Интернет).
 * Используется на странице детализации счёта и для генерации моковых счетов.
 * Суммы в копейках.
 */
