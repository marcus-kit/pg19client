/**
 * Секция «Контакты» на странице профиля.
 * Показывает: телефон, email, Telegram, VK ID.
 * Для каждого контакта отображает статус (Подтверждён / Привязан / Не указан).
 * Данные из useUserStore.
 */
'use client'
